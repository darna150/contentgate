...
const pillBase =
  "rounded-control border px-3 py-1.5 text-sm font-semibold transition-colors";
        ...
        <fieldset className="flex flex-col gap-3 border-0 p-0">
          ...
          <div className="flex flex-wrap gap-2">
            {SIZES.map((s) => (
              ...
              >
                {s.label}{" "}
                <span className="font-normal">{s.dims}</span>
              </button>
            ))}
          </div>
        </fieldset>
          ...
          <div className="flex h-full flex-col justify-between gap-4 p-5">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="flex items-center gap-1.5 rounded-full bg-approve-tint px-2 py-1">
                <span
                  aria-hidden="true"
                  className="h-1.5 w-1.5 rounded-full bg-approve"
                />
                {/* Use the darker accent text token on the pale status tint. */}
