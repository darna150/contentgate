...
export const TEMPLATE_OUTPUT_SIZES = {
  square: { label: "IG Square", w: 1080, h: 1080 },
  portrait: { label: "IG Portrait", w: 1080, h: 1350 },
  story: { label: "IG Story", w: 1080, h: 1920 },
  linkedin_square: { label: "LinkedIn Square", w: 1200, h: 1200 },
  feed: { label: "FB Landscape", w: 1200, h: 630 },
  link_ad: { label: "FB Landscape", w: 1200, h: 628 },
...
export const TEMPLATE_LAYOUT_CONTRACTS: Record<string, TemplateLayoutContract> = {
  ...
  contentgate_local_friendly: {
    ...
    editableFields: ["headline", "subheadline", "cta", "proof_note"],
    requiredLockedFields: [
      "logo",
      "product_cutout",
      "background_scene",
