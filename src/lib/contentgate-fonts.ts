...
export function loadContentGateFonts(): Promise<ContentGateFont[]> {
  if (!fontPromise) {
    fontPromise = Promise.all([
      ...
      ([interRegular, interMedium, interSemi, interBold]) => [
        { name: "ContentGate Sans", data: interRegular, weight: 400, style: "normal" },
        { name: "ContentGate Sans", data: interMedium, weight: 500, style: "normal" },
        { name: "ContentGate Sans", data: interSemi, weight: 600, style: "normal" },
        { name: "ContentGate Sans", data: interBold, weight: 700, style: "normal" },
        { name: "ContentGate Sans", data: interBold, weight: 800, style: "normal" },
